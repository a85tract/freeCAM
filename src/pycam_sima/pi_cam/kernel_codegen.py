...
def generate_direct_kernel_module(kernels: tuple[DirectKernel, ...]) -> str:
    lines = [
        "! Generated by pycam_sima.pi_cam.kernel_codegen; do not edit.",
        "module pycam_pi_cam_direct_kernels",
    ...
    lines.append("end module pycam_pi_cam_direct_kernels")
    lines.append("")
    return "\n".join(lines)
