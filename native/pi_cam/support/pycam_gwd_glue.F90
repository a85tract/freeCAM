! tphysac (physpkg.F90:1563-1571) hoisted for the
...
module pycam_gwd_glue
  ...
  use pycam_gwd_driver, only: driver_bind
  implicit none
  private
...
contains
  ...
  subroutine glue_enter(lchnk_in)
    ...
    call glue_view(comsrf_sgh(:, lchnk_in), address)
    call c_f_pointer(address, sgh, (/ pcols /))
  ...
  subroutine glue_bind_driver()
    ! physpkg.F90:1565-1565: the call's actuals bound to the unit's dummies
    call driver_bind(state, sgh, pbuf, ztodt, ptend, cam_in, flx_heat)
  end subroutine glue_bind_driver

  subroutine glue_piece_1()
    ! physpkg.F90:1563-1563, verbatim
  ...
  subroutine glue_piece_2()
    ! physpkg.F90:1567-1571, verbatim
