! tphysbc (physpkg.F90:2413-2414) hoisted for the
...
module pycam_awet_glue
  ...
  use pycam_awet_driver, only: driver_bind
  implicit none
  private
  public :: glue_piece_1, glue_enter, glue_bind_driver
...
contains
  ...
  subroutine glue_enter(lchnk_in)
    ...
    if (status /= 0_c_int .or. ndims /= 2_c_int) call endrun('pycam_awet_runner: carry dlf refused')
  ...
  subroutine glue_bind_driver()
    ! physpkg.F90:2413-2413: the call's actuals bound to the unit's dummies
    call driver_bind( state, ztodt, dlf, cam_out, ptend, pbuf)
  end subroutine glue_bind_driver

  subroutine glue_piece_1()
    ! physpkg.F90:2414-2414, verbatim
